        ...
        <div id="content-wrapper" class="d-flex flex-column">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 text-dark">
                            <div class="card mb-3 justify-content-center">
                                <div class="card-body">
                                    <div class="overflow-scroll justify-content-center align-items-center">
                        ...
                        <div class="container d-flex justify-content-center py-1">
                            <!-- Homepage Button -->
                            <a href="homepage" class="btn btn-lg btn-info" type="button">Homepage</a>
                            <div class="ml-auto">
                                <!-- Video Button -->
                                <a href="{{ route('video-3', ['modul' => $modul]) }}" class="btn btn-lg btn-info" type="button">Video</a>
                                <!-- Quiz Button -->
                                <a href="{{ route('quiz-3', ['modul' => $modul]) }}" class="btn btn-lg btn-info" type="button">Quiz</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <div class="col-md-12">
                                ...
                                <a href="login" class="btn btn-danger" type="submit">Ya, Keluar!</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function() {
                    var url = '{{ asset("storage/" . $isi_modul) }}'; // Replace with your PDF file path
