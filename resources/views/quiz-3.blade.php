                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 text-dark">
                            <div class="card mb-3 justify-content-center">
                                <div class="card-body">
                                    <div class="overflow-scroll-text">
                                        {{$quiz}}
                                    </div>
                                </div>
                            </div>
                        ...
                        <!-- Isi Quiz -->
                        <form action="quiz-4" method="POST" class="col-md-12 text-dark form-group">
                            @csrf
                            <!-- Menambahkan CSRF token untuk keamanan -->
                             <input type="hidden" name="modul" value="{{$modul}}">
                            <div class="card mb-3 justify-content-center">
                                <div class="card-body d-flex flex-column align-items-center">
                                    <textarea class="form-control-text" id="formGroupExampleInput" name="jawaban"
                                        placeholder="Jawaban anda..."></textarea>
                                    <!-- Submit Button -->
                                    <button class="btn btn-lg btn-info mt-2 ml-auto" type="submit">Submit</button>
                                </div>
                            </div>
                        </form>
                        ...
                        <div class="container d-flex justify-content-center py-1">
                            ...
                            <div class="ml-auto">
                                <!-- Video Button -->
                                <a href="{{ route('materi-3', ['modul' => $modul]) }}" class="btn btn-lg btn-info"
                                    type="button">
                                    Materi
                                </a>

                                <!-- Quiz Button -->
                                <a href="{{ route('video-3', ['modul' => $modul]) }}" class="btn btn-lg btn-info"
                                    type="button">
                                    Video
                                </a>
                            </div>
